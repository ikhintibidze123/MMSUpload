...
export function fillCeilingHeight(document, message) {
    ...
    var ceilingHeight = document.getElementById("CeilingHeight_1071");
    ceilingHeight.value = "3";
    ...
    ceilingHeight.dispatchEvent(event);
...
export function fillTotalArea(document, message) {
    ...
    var estateSpace = document.getElementById("AreaSize_706");
    estateSpace.value = message.message.estateSpace;
}



export function fillYardSpace(document, message) {
    var yardSpace = document.getElementById("YardSize_3517");
    yardSpace.value = message.message.yardSpace;
}


export function fillAllFloor(document, message) {
    var allFloor = document.getElementById("Floors_707");
...
export function fillRooms(document, message) {
    const selectElement = document.getElementById("Rooms_708");
...
export function fillBedrooms(document, message) {
    const selectElement = document.getElementById("BedRooms_710");
...
export function fillWetPoints(document, message) {
    const selectElement = document.getElementById("BathRooms_711");
...
export function hasBalcony(document, message) {
    var balconyCheckbox = document.getElementById("Balcony_714");
...
export function hasLoggia(document, message) {
    var loggiaCheckbox = document.getElementById("Loggia_713");
...
export function hasPorch(document, message) {
    var porchCheckbox = document.getElementById("Veranda_715");
...
export function hasStorage(document, message) {
    var storageCheckbox = document.getElementById("StoreType_716");
...
export function hasGas(document, message) {
    var gasCheckbox = document.getElementById("Gas_755");
...
export function hasInternet(document, message) {
    var internetCheckbox = document.getElementById("Internet_1051");
...
export function hasFireplace(document, message) {
    var fireplaceCheckbox = document.getElementById("FirePlace_3491");
...
export function fillParkingType(document, message) {
    ...
    const selectElement = document.getElementById("ParkingID_3499");
    var parkingTypeId = "";
...
export function fillHotWaterType(document, message) {
    ...
    const selectElement = document.getElementById("HotWaterID_3505");
    var hotwaterTypeId = "";
...
export function fillHeatingType(document, message) {
    ...
    const selectElement = document.getElementById("WarmingID_3512");
    var warmingTypeId = "";
...
export function checkFurnTech(document, message) {
 ...
 const radio1 = document.getElementById("HasFurnitureAndTechnic_781");
 const radio2 = document.getElementById("HasFurnitureAndTechnic_782");
...
export function checkPhone(document, message) {
    ...
    const radio1 = document.getElementById("Telephone_789");
...
export function checkTV(document, message) {
    ...
    const radio1 = document.getElementById("TV_790");
...
export function checkConditioner(document, message) {
    ...
    const radio1 = document.getElementById("Conditioner_791");
...
export function checkFurniture(document, message) {
    ...
    const radio1 = document.getElementById("Furniture_788");
...
export function fillRentHoleHouse(document, message) {
    ...
    const selectElement = document.getElementById("RentType_1102");
